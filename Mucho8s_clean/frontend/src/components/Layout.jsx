          ...
          <div className="ml-auto flex items-center">
            {discordPlayer && (
              <Link
                ...
                className="relative w-10 h-10 rounded-xl border border-[#242A35] bg-[#11151C] hover:bg-white/[0.05] hover:border-[#343B48] transition-all flex items-center justify-center text-[#AAB1BE] hover:text-white"
              >
                <Bell size={19} />
